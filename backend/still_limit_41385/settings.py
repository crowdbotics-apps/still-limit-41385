"""
Django settings for still_limit_41385 project.
...
ROOT_URLCONF = 'still_limit_41385.urls'
...
WSGI_APPLICATION = 'still_limit_41385.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "still_limit_41385 API",
    "DESCRIPTION": "API documentation for still_limit_41385 App",
    "VERSION": "v1",
}
